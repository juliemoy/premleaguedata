...
# assign points to results (2pts for a win up to 1980-81 season then 3 pts for a win afterwards)
...
table <- table %>%
  dplyr::mutate(
    SeasonLabel = dplyr::case_when(
      ...
      dplyr::between(Season, 1989, 1990) ~ paste(Season, "Julie was born on 14 February, 1989", sep = " - "),
      ...
      dplyr::between(Season, 2013, 2017) ~ paste(Season, "Goal Line Technology introduced in Premier League in 2013", sep = " - "),
